...
const openDialogBtnGigs = document.querySelectorAll(".open-dialog-btn-gigs");
const closeDialogBtnGigs = document.querySelectorAll(".close-dialog-btn-gigs");
...
// });
openDialogBtnGigs.forEach((btn) => {btn.addEventListener("click", () => {
    dialogBoxGigs.style.display = "flex";
});})
closeDialogBtnGigs.forEach((btn) => {btn.addEventListener("click", () => {
    dialogBoxGigs.style.display = "none";
});})
